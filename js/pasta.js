...
fetch("https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?number=1000&ranking=1&ignorePantry=false&ingredients=pasta", {
	"method": "GET",
	"headers": {
...
.then((text) => {
  ...
  document.getElementById("ingredients").innerHTML = `${recipe_list.length} recommended pasta recipe results`;
